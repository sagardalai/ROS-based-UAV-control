...
# from auto.msg import one_d_array
...
#     sub_aruco_data = rospy.Subscriber('aruco_code',one_d_array, aruco_data_callback,queue_size=1)
...
def con():
    ...
    print ('errorz :::::::::::::::: ',[errorx,errory,errorz])
    ekm1x=errorx
    ekm1y=errory
    ekm1z=errorz
