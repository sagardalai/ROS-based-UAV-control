...
with np.load('/home/kaushal/sft_match_ws/src/auto/src/3D-pose-estimation-of-a-planar-object/Calibration/BBB.npz') as X:
...
def pos_cb(msg):
    ...
    if img is None:
        ...
        # break
    # for fname in glob.glob('/home/kaushal/sft_match_ws/src/auto/src/3D-pose-estimation-of-a-planar-object/Chess_images/lleft16.jpg'):
...
if __name__=='__main__':
    try:
      ...
      depth_img_sub=rospy.Subscriber("/r200/depth/image_raw4/compressed",CompressedImage,pos_cb)
      rospy.spin()
